...
More information on the project, its requirements and a step-by-step guide to its use are contained within the [Wiki](https://github.com/MichaelPlug/CAKE-Algorand/wiki).